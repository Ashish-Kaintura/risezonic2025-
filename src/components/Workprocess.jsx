export default function Workprocess() {
  return (
    <div>
      <div className="sm:flex hidden">
        <div className="flex-block text-center justify-center pt-10 relative container mx-auto">
          ...
          <div className="sm:flex sm:justify-between justify-center bg-gray-200 ">
            <div className="sm:h-100 w-full flex justify-center text-center bg-gray-200  pr-0 pl-0 pt-6 pb-0   ">
              <article>
                <section className="bg-white sm:h-[35rem] flex justify-center text-center items-center ">
            ...
            <div className="sm:h-100 w-full bg-gray-300 overflow-hidden ">
              <img
                loading="lazy"
                className="bg-contain bg-center sm:h-full w-full "
                // src={Workprocess1}
          ...
          <div className="sm:flex sm:justify-between justify-center bg-gray-200 ">
            <div className="sm:h-100 w-full bg-gray-300 overflow-hidden ">
              <img
                loading="lazy"
                className="bg-cover bg-center sm:h-full w-full "
            ...
            <div className="sm:h-100 w-full flex justify-center text-center bg-gray-200  pl-0 pr-0 pt-0 pb-0  ">
              <article>
                <section className="bg-white sm:h-[35rem] flex justify-center text-center items-center ">
                  <div className="relative p-4">
                    <h2 className="text-4xl font-heading text-primary">
      ...
      <div className="sm:hidden flex-col text-center justify-center pt-10 relative container mx-auto">
        <h2 className="text-4xl font-heading ">Work Process</h2>
        ...
        <div className="flex flex-col sm:flex-row justify-center bg-gray-200 ">
          <div className="flex flex-col sm:w-1/2 w-full bg-gray-300 overflow-hidden">
            <img
              loading="lazy"
              className="bg-contain bg-center w-full h-auto"
              src="https://raw.githubusercontent.com/Ashish-Kaintura/risezonic2025-/main/src/assets/images/Home/workprocess1.jpg"
              alt="Plan & Create"
            />
            <div className="p-4">
              <h2 className="text-4xl font-heading text-primary">Plan & Create</h2>
              {/* <span className="text-amber-600 text-4xl font-semibold absolute top-4 left-0 right-0 bottom-0 inset-0 ">
                ______________
              </span> */}
              <p className="pt-8">
          ...
          <div className="flex flex-col sm:w-1/2 w-full bg-gray-300 overflow-hidden">
            ...
            />
            <div className="p-4">
              <h2 className="text-4xl font-heading text-primary">Develop & Testing</h2>
              {/* <span className="text-amber-600 text-4xl font-semibold absolute top-4 left-0 right-0 bottom-0 inset-0 ">
                ______________
              </span> */}
              <p className="pt-8">
        ...
        <div className="flex flex-col sm:flex-row justify-center bg-gray-200 ">
          <div className="flex flex-col sm:w-1/2 w-full bg-gray-300 overflow-hidden">
            ...
            />
            <div className="p-4">
              <h2 className="text-4xl font-heading text-primary">Make Live</h2>
              {/* <span className="text-amber-600 text-4xl font-semibold absolute top-4 left-0 right-0 bottom-0 inset-0 ">
                ______________
              </span> */}
              <p className="pt-8">
